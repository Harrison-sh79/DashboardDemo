 ...
 * @Last Modified time: 2024-02-29 10:45:01
 */
"use client";
        ...
        <KBarPositioner>
          ...
          >
            ...
            >
              ...
              <IoMdClose className="text-primary cursor-pointer" size={18} onClick={query.toggle} />
            </div>
            <RenderResults />
          </KBarAnimator>
        </KBarPositioner>
