...
function MapChart() {
  ...
  return (
    <div className="max-w-[85rem] mx-auto my-3 px-4 sm:px-6 lg:px-8">
      <div className="grid md:grid-cols-2 md:items-center sm:grid-cols-1">
        <div className="mr-15">
          <ComposableMap
            projectionConfig={{
              center: [0, 1],
          ...
          <Tooltip id="my-tooltip" place="left-end" border={`1px solid ${colors.violet[800]}`} style={{fontSize: "12", backgroundColor: colors.white, color: colors.violet[800], fontWeight: "bold", borderStyle:"solid", borderColor:colors.violet[800]}}>{content}</Tooltip>
        </div>
        {/* <!-- End Col --> */}

        <div className="relative ms-4">
          <div className="overflow-x-auto dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
