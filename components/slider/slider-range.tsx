        ...
        >
          ...
          {localValues.map((value, index) => (
            <React.Fragment key={index}>
              ...
              <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full border border-slider bg-white shadow transition-colors disabled:pointer-events-none disabled:opacity-50 hover:ring-4 hover:ring-violet-500" />
            </React.Fragment>
          ))}
        </SliderPrimitive.Root>
      );
